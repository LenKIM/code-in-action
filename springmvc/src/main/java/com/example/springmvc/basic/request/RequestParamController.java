...
public class RequestParamController {
    ...
    public String requestParamV2(
        ...
        // ViewResolver 로 ok 를 찾습니다. 그러나 @ResponseBody 를 넣으면 HTML 에 꽈악 박힌다
        return "ok";
    ...
    /**
     * @RequestParam.required * /request-param -> username이 없으므로 예외 * * 주의!
     * /request-param?username= -> 빈문자로 통과 * * 주의!
     * /request-param * int age -> null을 int에 입력하는 것은 불가능,
